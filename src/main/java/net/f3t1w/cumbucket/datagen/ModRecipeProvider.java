...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        oreBlasting(pWriter, SMELTABLES, RecipeCategory.MISC, ModItems.KISKA.get(), 0.25f, 200, "kiska");
        oreSmelting(pWriter, SMELTABLES, RecipeCategory.MISC, ModItems.KISKA.get(), 0.25f, 200, "kiska");
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.F_BLOCK.get())
                ...
                .unlockedBy(getHasName(ModItems.CUM_COOKIE.get()), has(ModItems.CUM_COOKIE.get()))
                .save(pWriter);
    ...
    protected static void oreCooking(Consumer<FinishedRecipe> pFinishedRecipeConsumer, RecipeSerializer<? extends AbstractCookingRecipe> pCookingSerializer, List<ItemLike> pIngredients, RecipeCategory pCategory, ItemLike pResult, float pExperience, int pCookingTime, String pGroup, String pRecipeName) {
        for(ItemLike itemlike : pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), pCategory, pResult, pExperience, pCookingTime, pCookingSerializer).
                    ...
                    save(pFinishedRecipeConsumer, CumBucket.MOD_ID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
        }
